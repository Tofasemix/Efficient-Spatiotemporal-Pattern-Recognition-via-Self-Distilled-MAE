...
def get_configs_shanghai():
    ...
    config.use_only_masked_tokens_ab = False
    config.run_type = "train"
    config.resume = 'experiments/shanghai/checkpoint-latest.pth'
    ...
    config.shanghai_path = "/home/udlap/Desktop/Video Anomaly Detection/aed-mae/datasets/shanghaitech_aug"
    config.shanghai_gt_path = "/home/udlap/Desktop/Video Anomaly Detection/aed-mae/datasets/shanghaitech_aug/test/test_frame_mask"
    config.percent_abnormal = 0.25
    config.input_3d = True
    config.device = "cuda"
